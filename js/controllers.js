angular.module('starter.controllers', [])
        ...
        .controller('favoritosctrl', function ($scope, $stateParams,$state,$ionicHistory) {
  ...
  $scope.goToCategory = function(){
        ...
        .controller('customerctrl', function ($scope, $stateParams,$state,$ionicHistory) {
  $scope.goToCategory = function(){
                $ionicHistory.nextViewOptions({
                disableAnimate: true,
                disableBack: true
        ...
        .controller('contactctrl', function ($scope, $stateParams,$state,$ionicHistory) {
